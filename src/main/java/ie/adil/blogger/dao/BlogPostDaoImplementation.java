...
//@Scope("prototype")
@Repository
public class BlogPostDaoImplementation implements BlogPostDao{
	...
	@Autowired
	public BlogPostDaoImplementation(DataSource dataSource) {
	...
	public boolean save(BlogPost blogPost) {
		...
		blogPostObj.setBlogTitle(blogPost.getBlogTitle());
		return false;
	}
}
